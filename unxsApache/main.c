...
FILE 
	...
	mysqlRAD2.cgi created application file for mysqlApache2.cgi
...
void mysqlApache2(const char *cResult);
...
int main(int iArgc, char *cArgv[])
{
	...
	if(!strstr(cArgv[0],"mysqlApache2.cgi"))
	...
	if(strcmp(getenv("REQUEST_METHOD"),"POST"))
	{
		...
		if(gcFunction[0])
		{
			...
			{
				printf("Set-Cookie: mysqlApache2Login=; expires=\"Mon, 01-Jan-1971 00:10:10 GMT\"\n");
				printf("Set-Cookie: mysqlApache2Passwd=; expires=\"Mon, 01-Jan-1971 00:10:10 GMT\"\n");
				gcCookie[0]=0;
                                guPermLevel=0;
                                guLoginClient=0;
                                gcUser[0]=0;
			...
			else if(!strcmp(gcFunction,"tSite"))
				ExttSiteGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tSiteUser"))
				ExttSiteUserGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tIP"))
				ExttIPGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tSSLCert"))
				ExttSSLCertGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tMySQL"))
				ExttMySQLGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tMySQLUser"))
				ExttMySQLUserGetHook(gentries,x);
	...
	//Main Post Menu
	tSiteCommands(entries,x);
	tSiteUserCommands(entries,x);
	tIPCommands(entries,x);
	tSSLCertCommands(entries,x);
	tClientCommands(entries,x);
	tTemplateCommands(entries,x);
	tTemplateSetCommands(entries,x);
	tMySQLCommands(entries,x);
	tMySQLUserCommands(entries,x);
...
void Header_ism3(char *title, int js)
{
	...
	printf("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n");
        printf("<html><head><title>mysqlApache2 %s </title>",title);
	printf("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=iso-8859-1\">\n");
	StyleSheet();

	printf("</head><body><form action=mysqlApache2.cgi method=post><blockquote>\n");

	//ModuleRAD3NavBars()
	if(!strcmp(gcFunction,"tSite") || !strcmp(gcFunction,"tSiteTools") ||
			!strcmp(gcFunction,"tSiteList"))
		ExttSiteNavBar();
	else if(!strcmp(gcFunction,"tSiteUser") || !strcmp(gcFunction,"tSiteUserTools") ||
			!strcmp(gcFunction,"tSiteUserList"))
		ExttSiteUserNavBar();
	else if(!strcmp(gcFunction,"tIP") || !strcmp(gcFunction,"tIPTools") ||
			!strcmp(gcFunction,"tIPList"))
		ExttIPNavBar();
	else if(!strcmp(gcFunction,"tSSLCert") || !strcmp(gcFunction,"tSSLCertTools") ||
			!strcmp(gcFunction,"tSSLCertList"))
		ExttSSLCertNavBar();
	else if(!strcmp(gcFunction,"tMySQL") || !strcmp(gcFunction,"tMySQLTools") ||
			!strcmp(gcFunction,"tMySQLList"))
		ExttMySQLNavBar();
	else if(!strcmp(gcFunction,"tMySQLUser") || !strcmp(gcFunction,"tMySQLUserTools") ||
			!strcmp(gcFunction,"tMySQLUserList"))
		ExttMySQLUserNavBar();
	...
	//Login info
	printf("<font size=3><b>mysqlApache2</b></font> \n ");
	if(!guPermLevel)
	...
	//Logout link
	if(guSSLCookieLogin)
		printf(" <a title='Erase login cookies' href=mysqlApache2.cgi?gcFunction=Logout>Logout</a> ");
	...
	if(strncmp(gcFunction,"Main",4))
		...
		printf(" id=current>\n");
		printf("\t\t\t<a title='Home start page' href=mysqlApache2.cgi?gcFunction=Main>Main</a>\n");
	printf("\t\t\t</li>\n");
	...
	if(guPermLevel>=7)
	{
	  ...
	  if(strcmp(gcFunction,"tSite") && strcmp(gcFunction,"tSiteTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tSite' href=mysqlApache2.cgi?gcFunction=tSite>tSite</a>\n");
	}
	//tSiteUser
	if(guPermLevel>=20)
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tSiteUser") && strcmp(gcFunction,"tSiteUserTools") &&
			strcmp(gcFunction,"tSiteUserList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tSiteUser' href=mysqlApache2.cgi?gcFunction=tSiteUser>tSiteUser</a>\n");
	}
	//tMySQL
	if(guPermLevel>=20)
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tMySQL") && strcmp(gcFunction,"tMySQLTools") &&
			strcmp(gcFunction,"tMySQLList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tMySQL' href=mysqlApache2.cgi?gcFunction=tMySQL>tMySQL</a>\n");
	}
	//tMySQLUser
	if(guPermLevel>=20)
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tMySQLUser") && strcmp(gcFunction,"tMySQLUserTools") &&
			strcmp(gcFunction,"tMySQLUserList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tMySQLUser' href=mysqlApache2.cgi?gcFunction=tMySQLUser>tMySQLUser</a>\n");
	}
	//tIP
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tIP") && strcmp(gcFunction,"tIPTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tIP' href=mysqlApache2.cgi?gcFunction=tIP>tIP</a>\n");
	}
	//tSSLCert
	if(guPermLevel>=20)
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tSSLCert") && strcmp(gcFunction,"tSSLCertTools") &&
			strcmp(gcFunction,"tSSLCertList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tSSLCert' href=mysqlApache2.cgi?gcFunction=tSSLCert>tSSLCert</a>\n");
	}
	//tClient
	if(guPermLevel>=7)
	{
	  ...
	  if(strcmp(gcFunction,"tClient") && strcmp(gcFunction,"tClientTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='Customer or Customer Contact Info' href=mysqlApache2.cgi?gcFunction=tClient>tClient</a>\n");
	}
	//tTemplate
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tTemplate") && strcmp(gcFunction,"tTemplateTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tTemplate' href=mysqlApache2.cgi?gcFunction=tTemplate>tTemplate</a>\n");
	}
	//tTemplateSet
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tTemplateSet") && strcmp(gcFunction,"tTemplateSetTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tTemplateSet' href=mysqlApache2.cgi?gcFunction=tTemplateSet>tTemplateSet</a>\n");
	}
	//tTemplateType
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tTemplateType") && strcmp(gcFunction,"tTemplateTypeTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tTemplateType' href=mysqlApache2.cgi?gcFunction=tTemplateType>tTemplateType</a>\n");
	}
	//tJob
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tJob") && strcmp(gcFunction,"tJobTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tJob' href=mysqlApache2.cgi?gcFunction=tJob>tJob</a>\n");
	}
	//tLog
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tLog") && strcmp(gcFunction,"tLogTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tLog' href=mysqlApache2.cgi?gcFunction=tLog>tLog</a>\n");
	}
	//tLogType
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tLogType") && strcmp(gcFunction,"tLogTypeTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tLogType' href=mysqlApache2.cgi?gcFunction=tLogType>tLogType</a>\n");
	}
	//tLogMonth
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tLogMonth") && strcmp(gcFunction,"tLogMonthTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tLogMonth' href=mysqlApache2.cgi?gcFunction=tLogMonth>tLogMonth</a>\n");
	}
	//tMonth
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tMonth") && strcmp(gcFunction,"tMonthTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tMonth' href=mysqlApache2.cgi?gcFunction=tMonth>tMonth</a>\n");
	}
	//tConfiguration
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tConfiguration") && strcmp(gcFunction,"tConfigurationTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tConfiguration' href=mysqlApache2.cgi?gcFunction=tConfiguration>tConfiguration</a>\n");
	}
	//tServer
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tServer") && strcmp(gcFunction,"tServerTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tServer' href=mysqlApache2.cgi?gcFunction=tServer>tServer</a>\n");
	}
	//tStatus
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tStatus") && strcmp(gcFunction,"tStatusTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tStatus' href=mysqlApache2.cgi?gcFunction=tStatus>tStatus</a>\n");
	}
	//tJobStatus
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tJobStatus") && strcmp(gcFunction,"tJobStatusTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tJobStatus' href=mysqlApache2.cgi?gcFunction=tJobStatus>tJobStatus</a>\n");
	}
	//tAuthorize
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tAuthorize") && strcmp(gcFunction,"tAuthorizeTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='Login Authorization' href=mysqlApache2.cgi?gcFunction=tAuthorize>tAuthorize</a>\n");
	}
	//tGlossary
	if(guPermLevel>=20)
	{
	  ...
	  if(strcmp(gcFunction,"tGlossary") && strcmp(gcFunction,"tGlossaryTools") &&
		  ...
		  printf(" id=current>\n");
	  printf("\t\t\t<a title='tGlossary' href=mysqlApache2.cgi?gcFunction=tGlossary>tGlossary</a>\n");
	}
...
void ConnectDb(void)
{
		...
		{
	                mysqlApache2("Database server unavailable. Did you run mysqlApache2.cgi Initialize &lt;mysqlpwd&gt;?");
		}
        }
...
char *TextAreaSave(char *cField)
{
	...
	if(!cCopy) mysqlApache2("TextAreaInput() malloc error");
...
char *TransformAngleBrackets(char *cField)
{
	...
	if(!cCopy) mysqlApache2("TransformAngleBrackets() malloc error");
...
char *EncodeDoubleQuotes(char *cField)
{
	...
	if(!cCopy) mysqlApache2("EncodeDoubleQuotes() malloc error");
...
void InitialInstall(void)
{
	mysqlApache2("Please run\
		mysqlApache2.cgi Initialize &lt;mysqlpwd&gt; from the command line");
...
void SetLogin(void)
{
	if( iValidLogin(0) )
	{
		printf("Set-Cookie: mysqlApache2Login=%s;\n",gcLogin);
		printf("Set-Cookie: mysqlApache2Passwd=%s;\n",gcPasswd);
...
int iValidLogin(int mode)
{
	...
	if(!mode)
	{
		sprintf(gcQuery,"INSERT INTO tLog SET cLabel='login failed %.99s',uLogType=6,uPermLevel=%u,uLoginClient=%u,cLogin='%.99s',cHost='%.99s',cServer='%.99s',uOwner=%u,uCreatedBy=1,uCreatedDate=UNIX_TIMESTAMP(NOW())",gcLogin,guPermLevel,guLoginClient,gcLogin,gcHost,gcHostname,guCompany);
		mysql_query(&gMysql,gcQuery);
	}
	return 0;
...
void SSLCookieLogin(void)
{
	...
	if(getenv("HTTPS")==NULL) 
		mysqlApache2("Non SSL access denied");
#endif
	...
	if((ptr=strstr(gcCookie,"mysqlApache2Login=")))
	{
		ptr+=strlen("mysqlApache2Login=");
		if((ptr2=strchr(ptr,';')))
		{
			*ptr2=0;
	...
	if((ptr=strstr(gcCookie,"mysqlApache2Passwd=")))
	{
		ptr+=strlen("mysqlApache2Passwd=");
		if((ptr2=strchr(ptr,';')))
		{
			*ptr2=0;
...
void mysqlApache2Log(unsigned uTablePK, char *cTableName, char *cLogEntry)
{
        char cQuery[512];

	//uLogType==1 is this back-office cgi by default tLogType install
        sprintf(cQuery,"INSERT INTO tLog SET cLabel='%.63s',uLogType=1,uPermLevel=%u,uLoginClient=%u,cLogin='%.99s',cHost='%.99s',uTablePK=%u,cTableName='%.31s',uOwner=%u,uCreatedBy=1,uCreatedDate=UNIX_TIMESTAMP(NOW())",cLogEntry,guPermLevel,guLoginClient,gcLogin,gcHost,uTablePK,cTableName,guCompany);
...
void htmlPlainTextError(const char *cError)
{
	...
	printf("Please report this mysqlApache2 fatal error ASAP:\n%s\n",cError);

	//Attempt to report error in tLog
        sprintf(cQuery,"INSERT INTO tLog SET cLabel='htmlPlainTextError',uLogType=4,uPermLevel=%u,uLoginClient=%u,cLogin='%s',cHost='%s',cMessage=\"%s\",cServer='%s',uOwner=%u,uCreatedBy=%u,uCreatedDate=UNIX_TIMESTAMP(NOW())",guPermLevel,guLoginClient,gcLogin,gcHost,cError,gcHostname,guLoginClient,guCompany);
        mysql_query(&gMysql,cQuery);
        if(mysql_errno(&gMysql))
