...
#define LANG_NBB_NEWREV  "<input type='submit' title='Create new record' class='new' name=gcFind value='New' />"
//#define LANG_NBB_NEW "<input  title=\"Create new record\" type=submit name=gcCommand value=New>"
#define LANG_NBB_NEW  "<input type='submit' title='Create new record' class='new' name=gcFind value='New' />"
//#define LANG_NBB_DELETE "<input class=warnButton title=\"Delete current record\" type=submit name=gcCommand value=Delete>"
#define LANG_NBB_DELETE "<input type='submit' title='Delete current record' class='delete' name=gcFind value='Delete' />"
//#define LANG_NBB_MODIFY "<input class=alertButton title=\"Modify current record\" type=submit name=gcCommand value=Modify>"
#define LANG_NBB_MODIFY "<input type='submit' title='Modify current record' class='modify' name=gcFind value='Modify' />"
