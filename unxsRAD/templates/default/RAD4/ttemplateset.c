/*
FILE
	tTemplateSet source code of {{cProject}}.cgi
	...
	if(!cResult[0])
	{
		...
		if(mysql_errno(&gMysql))
			...
			if(strstr(mysql_error(&gMysql)," doesn't exist"))
                	{
				CreatetTemplateSet();
				{{cProject}}("New tTemplateSet table created");
                	}
			else
			{
...
void NewtTemplateSet(unsigned uMode)
{
	...
	{{cProject}}Log(uTemplateSet,"tTemplateSet","New");
#endif
...
void DeletetTemplateSet(void)
{
	...
	{
#ifdef ISM3FIELDS
		{{cProject}}Log(uTemplateSet,"tTemplateSet","Del");
#endif
	...
	{
#ifdef ISM3FIELDS
		{{cProject}}Log(uTemplateSet,"tTemplateSet","DelError");
#endif
...
void ModtTemplateSet(void)
{
	...
	{{cProject}}Log(uTemplateSet,"tTemplateSet","Mod");
#endif
	tTemplateSet(gcQuery);
