...
{
	sprintf(gcQuery,"CREATE TABLE IF NOT EXISTS tProjectStatus ( uStatus INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, uOwner INT UNSIGNED NOT NULL DEFAULT 0,index (uOwner), uCreatedBy INT UNSIGNED NOT NULL DEFAULT 0, uCreatedDate INT UNSIGNED NOT NULL DEFAULT 0, uModBy INT UNSIGNED NOT NULL DEFAULT 0, uModDate INT UNSIGNED NOT NULL DEFAULT 0, cLabel VARCHAR(32) NOT NULL DEFAULT '', uLockMain INT UNSIGNED NOT NULL DEFAULT 0, uLockMainFunc INT UNSIGNED NOT NULL DEFAULT 0, uLockModule INT UNSIGNED NOT NULL DEFAULT 0, uLockModuleFunc INT UNSIGNED NOT NULL DEFAULT 0, uLockMakefile INT UNSIGNED NOT NULL DEFAULT 0, uLockInclude INT UNSIGNED NOT NULL DEFAULT 0, uLockLanguage INT UNSIGNED NOT NULL DEFAULT 0, uLockCapFiles INT UNSIGNED NOT NULL DEFAULT 0 )");
	mysql_query(&gMysql,gcQuery);
	if(mysql_errno(&gMysql))
		htmlPlainTextError(mysql_error(&gMysql));
}//CreatetProjectStatus()
