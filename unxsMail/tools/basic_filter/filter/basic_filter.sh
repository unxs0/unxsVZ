...
#
#FILE
#	$Id: basic_filter.sh 30 2006-03-27 21:38:23Z ggw $
#	basic_filter.sh
#PURPOSE
...
#
#	Note that $4 is ${recipient} and is used below with mysqlPostfix ActiveUser
#
#INSTALL NOTES
#
#
...
MYSQL_POSTFIX="/cgi-bin/mysqlPostfix.cgi";
MYSQL_POSTFIX_ACTIVEUSER="/cgi-bin/mysqlPostfix.cgi ActiveUser";
...
if [ -x $MYSQL_POSTFIX ]; then

        POSTFIXUSER=`$MYSQL_POSTFIX_ACTIVEUSER $4`;
	ACTIVEUSER_RESULT=$?;
