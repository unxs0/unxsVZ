...
char cInitTableList[64][32]={"tAuthorize","tClient","tConfigSpec","tConfiguration","tDomain","tJobStatus","tLogType","tServer","tServerGroup","tServerGroupGlue","tStatus","tTemplate","tTemplateSet","tTemplateType","tUserType",""};
