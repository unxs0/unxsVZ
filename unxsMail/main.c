...
int main(int iArgc, char *cArgv[])
{
	...
	if(strcmp(getenv("REQUEST_METHOD"),"POST"))
	{
		...
		if(gcFunction[0])
		{
			...
			else if(!strcmp(gcFunction,"tUser"))
				ExttUserGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tAlias"))
				ExttAliasGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tDomain"))
				ExttDomainGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tVUT"))
				ExttVUTGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tVUTEntries"))
				ExttVUTEntriesGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tAccess"))
				ExttAccessGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tRelay"))
				ExttRelayGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tLocal"))
				ExttLocalGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tUserType"))
				ExttUserTypeGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tUserConfig"))
				ExttUserConfigGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tServerConfig"))
				ExttServerConfigGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tConfigSpec"))
				ExttConfigSpecGetHook(gentries,x);
			...
			else if(!strcmp(gcFunction,"tServerGroup"))
				ExttServerGroupGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tServerGroupGlue"))
				ExttServerGroupGlueGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tConfiguration"))
				ExttConfigurationGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tHoldUser"))
				ExttHoldUserGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tRequest"))
				ExttRequestGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tWhiteList"))
				ExttWhiteListGetHook(gentries,x);
			else if(!strcmp(gcFunction,"tBlackList"))
	...
	tRelayCommands(entries,x);
	tLocalCommands(entries,x);
	tUserTypeCommands(entries,x);
	tUserConfigCommands(entries,x);
	tServerConfigCommands(entries,x);
	tConfigSpecCommands(entries,x);
	...
	tServerGroupCommands(entries,x);
	tServerGroupGlueCommands(entries,x);
	tConfigurationCommands(entries,x);
	tHoldUserCommands(entries,x);
	tRequestCommands(entries,x);
	tWhiteListCommands(entries,x);
	tBlackListCommands(entries,x);
	tVacationCommands(entries,x);
...
void Header_ism3(char *title, int js)
{
	...
	if(!strcmp(gcFunction,"tUser") || !strcmp(gcFunction,"tUserTools") ||
			!strcmp(gcFunction,"tUserList"))
		ExttUserNavBar();
	else if(!strcmp(gcFunction,"tAlias") || !strcmp(gcFunction,"tAliasTools") ||
			!strcmp(gcFunction,"tAliasList"))
		ExttAliasNavBar();
	else if(!strcmp(gcFunction,"tDomain") || !strcmp(gcFunction,"tDomainTools") ||
			!strcmp(gcFunction,"tDomainList"))
		ExttDomainNavBar();
	else if(!strcmp(gcFunction,"tVUT") || !strcmp(gcFunction,"tVUTTools") ||
			!strcmp(gcFunction,"tVUTList"))
		ExttVUTNavBar();
	else if(!strcmp(gcFunction,"tVUTEntries") || !strcmp(gcFunction,"tVUTEntriesTools") ||
			!strcmp(gcFunction,"tVUTEntriesList"))
		ExttVUTEntriesNavBar();
	else if(!strcmp(gcFunction,"tAccess") || !strcmp(gcFunction,"tAccessTools") ||
			!strcmp(gcFunction,"tAccessList"))
		ExttAccessNavBar();
	else if(!strcmp(gcFunction,"tRelay") || !strcmp(gcFunction,"tRelayTools") ||
			!strcmp(gcFunction,"tRelayList"))
		ExttRelayNavBar();
	else if(!strcmp(gcFunction,"tLocal") || !strcmp(gcFunction,"tLocalTools") ||
			!strcmp(gcFunction,"tLocalList"))
		ExttLocalNavBar();
	else if(!strcmp(gcFunction,"tUserType") || !strcmp(gcFunction,"tUserTypeTools") ||
			!strcmp(gcFunction,"tUserTypeList"))
		ExttUserTypeNavBar();
	else if(!strcmp(gcFunction,"tUserConfig") || !strcmp(gcFunction,"tUserConfigTools") ||
			!strcmp(gcFunction,"tUserConfigList"))
		ExttUserConfigNavBar();
	else if(!strcmp(gcFunction,"tServerConfig") || !strcmp(gcFunction,"tServerConfigTools") ||
			!strcmp(gcFunction,"tServerConfigList"))
		ExttServerConfigNavBar();
	else if(!strcmp(gcFunction,"tConfigSpec") || !strcmp(gcFunction,"tConfigSpecTools") ||
			!strcmp(gcFunction,"tConfigSpecList"))
		ExttConfigSpecNavBar();
		...
		ExttServerNavBar();
	else if(!strcmp(gcFunction,"tServerGroup") || !strcmp(gcFunction,"tServerGroupTools") ||
			!strcmp(gcFunction,"tServerGroupList"))
		ExttServerGroupNavBar();
	else if(!strcmp(gcFunction,"tServerGroupGlue") || !strcmp(gcFunction,"tServerGroupGlueTools") ||
			!strcmp(gcFunction,"tServerGroupGlueList"))
		ExttServerGroupGlueNavBar();
	...
	else if(!strcmp(gcFunction,"tHoldUser") || !strcmp(gcFunction,"tHoldUserTools") ||
			!strcmp(gcFunction,"tHoldUserList"))
		ExttHoldUserNavBar();
	else if(!strcmp(gcFunction,"tRequest") || !strcmp(gcFunction,"tRequestTools") ||
			!strcmp(gcFunction,"tRequestList"))
		ExttRequestNavBar();
	else if(!strcmp(gcFunction,"tWhiteList") || !strcmp(gcFunction,"tWhiteListTools") ||
			!strcmp(gcFunction,"tWhiteListList"))
		ExttWhiteListNavBar();
	else if(!strcmp(gcFunction,"tBlackList") || !strcmp(gcFunction,"tBlackListTools") ||
			!strcmp(gcFunction,"tBlackListList"))
		ExttBlackListNavBar();
	else if(!strcmp(gcFunction,"tVacation") || !strcmp(gcFunction,"tVacationTools") ||
			!strcmp(gcFunction,"tVacationList"))
		ExttVacationNavBar();
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tAlias") && strcmp(gcFunction,"tAliasTools") &&
			strcmp(gcFunction,"tAliasList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tDomain") && strcmp(gcFunction,"tDomainTools") &&
			strcmp(gcFunction,"tDomainList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tVUTEntries") && strcmp(gcFunction,"tVUTEntriesTools") &&
			strcmp(gcFunction,"tVUTEntriesList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tAccess") && strcmp(gcFunction,"tAccessTools") &&
			strcmp(gcFunction,"tAccessList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tRelay") && strcmp(gcFunction,"tRelayTools") &&
			strcmp(gcFunction,"tRelayList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tLocal") && strcmp(gcFunction,"tLocalTools") &&
			strcmp(gcFunction,"tLocalList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tUserType") && strcmp(gcFunction,"tUserTypeTools") &&
			strcmp(gcFunction,"tUserTypeList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tUserConfig") && strcmp(gcFunction,"tUserConfigTools") &&
			strcmp(gcFunction,"tUserConfigList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tServerConfig") && strcmp(gcFunction,"tServerConfigTools") &&
			strcmp(gcFunction,"tServerConfigList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tConfigSpec") && strcmp(gcFunction,"tConfigSpecTools") &&
			strcmp(gcFunction,"tConfigSpecList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tServerGroup") && strcmp(gcFunction,"tServerGroupTools") &&
			strcmp(gcFunction,"tServerGroupList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tServerGroupGlue") && strcmp(gcFunction,"tServerGroupGlueTools") &&
			strcmp(gcFunction,"tServerGroupGlueList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tHoldUser") && strcmp(gcFunction,"tHoldUserTools") &&
			strcmp(gcFunction,"tHoldUserList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tRequest") && strcmp(gcFunction,"tRequestTools") &&
			strcmp(gcFunction,"tRequestList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tWhiteList") && strcmp(gcFunction,"tWhiteListTools") &&
			strcmp(gcFunction,"tWhiteListList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tBlackList") && strcmp(gcFunction,"tBlackListTools") &&
			strcmp(gcFunction,"tBlackListList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
	...
	{
	  printf("\t\t\t<li");
	  if(strcmp(gcFunction,"tVacation") && strcmp(gcFunction,"tVacationTools") &&
			strcmp(gcFunction,"tVacationList"))
		  printf(">\n");
	  else
		  printf(" id=current>\n");
