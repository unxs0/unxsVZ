...
void NewtTemplateType(unsigned uMode)
{
	...
	sprintf(gcQuery,"SELECT uTemplateType FROM tTemplateType WHERE uTemplateType=%u",uTemplateType);
...
{
	sprintf(gcQuery,"DELETE FROM tTemplateType WHERE uTemplateType=%u",uTemplateType);
