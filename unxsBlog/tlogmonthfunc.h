/*
FILE
	$Id: tlogmonthfunc.h 612 2007-06-05 21:51:04Z ggw $
...
void LogMonthSummary(void)
{
	...
	else if(!strcmp(cTableName,"tResource"))
	{
		...
		printf("<a class=darkLink title='Jump to tResource entry' href=unxsBlog.cgi?gcFunction=tResource&uResource=%u>tResource</a><blockquote>\n",uTPK);
