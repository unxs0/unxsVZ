	...
	if(!cResult[0])
	{
		...
		if(mysql_errno(&gMysql))
			...
			if(strstr(mysql_error(&gMysql)," doesn't exist"))
				...
				unxsBlog("New tConfiguration table created");
                	}
			else
			{
...
void NewtConfiguration(unsigned uMode)
{
	...
	unxsBlogLog(uConfiguration,"tConfiguration","New");
#endif
...
void DeletetConfiguration(void)
{
	...
	{
#ifdef ISM3FIELDS
		unxsBlogLog(uConfiguration,"tConfiguration","Del");
#endif
	...
	{
#ifdef ISM3FIELDS
		unxsBlogLog(uConfiguration,"tConfiguration","DelError");
#endif
...
void ModtConfiguration(void)
{
	...
	unxsBlogLog(uConfiguration,"tConfiguration","Mod");
#endif
	tConfiguration(gcQuery);
