...
#*Modified for use with SpamAssassin by (C) Unixservice mods GPLv2 license applies to this
...
$pid_file_location = '/var/run/spamd.pid';
...
for (;;) {
 ...
 restart:
	...
	system("/etc/init.d/spamassassin restart > /dev/null 2>&1");
	sleep 11;
}
