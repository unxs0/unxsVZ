...
#Please note that this _must_ match tConfiguration cRadiusdPID value
$pid_file_location = '/usr/local/var/run/radiusd/radiusd.pid';
...
for (;;) {
 ...
 restart:
	...
	system("/usr/sbin/start-radius.sh");
	sleep 10;
}
