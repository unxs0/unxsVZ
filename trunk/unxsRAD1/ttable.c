...
{
	sprintf(gcQuery,"CREATE TABLE IF NOT EXISTS tTable ( uTable INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, cLabel VARCHAR(32) NOT NULL DEFAULT '', uOwner INT UNSIGNED NOT NULL DEFAULT 0,index (uOwner), uCreatedBy INT UNSIGNED NOT NULL DEFAULT 0, uCreatedDate INT UNSIGNED NOT NULL DEFAULT 0, uModBy INT UNSIGNED NOT NULL DEFAULT 0, uModDate INT UNSIGNED NOT NULL DEFAULT 0, uNewLevel INT UNSIGNED NOT NULL DEFAULT 0, uModLevel INT UNSIGNED NOT NULL DEFAULT 0, uDelLevel INT UNSIGNED NOT NULL DEFAULT 0, uReadLevel INT UNSIGNED NOT NULL DEFAULT 0, uTableOrder INT UNSIGNED NOT NULL DEFAULT 0, uSourceLock INT UNSIGNED NOT NULL DEFAULT 0, cLegend VARCHAR(100) NOT NULL DEFAULT '', cToolTip VARCHAR(100) NOT NULL DEFAULT '', cDescription VARCHAR(100) NOT NULL DEFAULT '', uProject INT UNSIGNED NOT NULL DEFAULT 0 )");
	mysql_query(&gMysql,gcQuery);
	if(mysql_errno(&gMysql))
		htmlPlainTextError(mysql_error(&gMysql));
}//CreatetTable()
