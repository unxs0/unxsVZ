...
FILE 
	glossary.c
	$Id: glossary.c 2735 2014-12-18 13:15:15Z Colin $
AUTHOR/LEGAL
	(C) 2010-2016 Gary Wallis for Unixservice, LLC.
	GPLv2 license applies. See included LICENSE file.
PURPOSE
	unxsVZ Portal Interface program file.
...
{
	htmlHeader("unxsPortal","Header");
	htmlGlossaryPage("unxsPortal","OrgGlossary.Body");
	htmlFooter("Footer");
