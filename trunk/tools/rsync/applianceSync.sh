...
ssh -p 12265 $1 "vzctl exec2 101 service asterisk start";
if [ $? != 0 ];then
...
/usr/bin/rsync -avz -e "ssh -p $cSSHPort" --delete root@$1:/vz/private/101/etc/asterisk/ /vz/private/$2/etc/asterisk/
if [ $? != 0 ] && [ $? != 24 ];then
	echo $?
	fLog "rsync 4 failed";
fi
...
/usr/bin/rsync -avz -e "ssh -p $cSSHPort" --delete root@$1:/vz/private/101/var/www/html/panel/ /vz/private/$2/var/www/html/panel/
...
if [ "$cStatus" == "running" ];then
	...
	/usr/bin/rsync -avz -e "ssh -p $cSSHPort" --delete root@$1:/vz/private/101/var/lib/mysql/asterisk/ /vz/private/$2/var/lib/mysql/asterisk/
	#/usr/bin/rsync $cDryrun -e '/usr/bin/ssh -ax -c arcfour -p '\'$cSSHPort\''' -avxlH  --delete \
	...
	/usr/bin/rsync -avz -e "ssh -p $cSSHPort" --delete root@$1:/vz/private/101/var/lib/mysql/asteriskcdrdb/ /vz/private/$2/var/lib/mysql/asteriskcdrdb/	
	#/usr/bin/rsync $cDryrun -e '/usr/bin/ssh -ax -c arcfour -p '\'$cSSHPort\''' -avxlH  --delete \
