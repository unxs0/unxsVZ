...
{
	if(cSearch[0])
		ExtSelectSearch("tGlossary",VAR_LIST_tGlossary,"cLabel",cSearch,NULL,20);
	else
...
void tGlossaryNavList(void)
{
	...
	ExtSelect("tGlossary","tGlossary.uGlossary,tGlossary.cLabel",20);
	...
	{	
			...
			printf("<a class=darkLink href=mysqlApache2.cgi?gcFunction=tGlossary&uGlossary=%s>%s</a><br>\n",field[0],field[1]);
	}
