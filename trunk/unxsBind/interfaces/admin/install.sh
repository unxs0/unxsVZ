...
#
#FILE
#	$Id: install.sh 660 2008-12-18 18:48:48Z hus $
#PURPOSE
#       Make a full install of idnsAdmin easy.
#AUTHOR
...
cp ./templates/images/* ${cWebdir}/images/
cp ./templates/popups.js ${cWebdir}/
cp ./templates/styles.css ${cWebdir}/
